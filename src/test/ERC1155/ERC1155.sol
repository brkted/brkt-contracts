...
contract ERC1155 is ERC165Storage, IERC1155 {
    ...
    constructor() {
        _registerInterface(
            ERC1155.safeTransferFrom.selector ^ ERC1155.safeBatchTransferFrom.selector ^ IERC1155.balanceOf.selector
                ^ IERC1155.balanceOfBatch.selector ^ ERC1155.setApprovalForAll.selector ^ ERC1155.isApprovedForAll.selector
        );
    }
